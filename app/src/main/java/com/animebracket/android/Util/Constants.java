...
public class Constants {
    ...
    //URLs
    public final static String BASE_URL = "http://bracket.awwni.me"; //"http://animebracket.com";
    ...
    public final static String CHARACTERS_LIST_URL = "/api/characters/?bracketId="; //immediately followed by the ID of the bracket you want to get the list of characters for
    public final static String BRACKET_ACTIVE_ROUND_URL = "/api/rounds/?bracketId="; //followed by bracket ID
    public final static String BRACKET_ALL_ROUNDS_URL = "/api/bracket/?bracketId="; //followed by bracket ID
    public final static String REDDIT_OAUTH_URL = "/api/login/";
    public final static String USER_DETAILS_URL = "/api/user/";
    public final static String POST_VOTE_URL = "/submit/?action=vote";
